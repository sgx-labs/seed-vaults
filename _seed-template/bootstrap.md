...
After the first session, your vault has generic [domain] knowledge PLUS project-specific intelligence that no one else has.
...
- **Searches before generating** -- your vault has [N]+ expert notes, growing with every session
...
|------|-----------|-----------------|
| [Topic 1] | `[search terms]` | `hub/[topic-1].md` |
| [Topic 2] | `[search terms]` | `hub/[topic-2].md` |
| [Topic 3] | `[search terms]` | `hub/[topic-3].md` |
| [Topic 4] | `[search terms]` | `hub/[topic-4].md` |
| [Topic 5] | `[search terms]` | `hub/[topic-5].md` |

## Key Questions This Seed Answers

1. [Question relevant to the seed domain]
2. [Question relevant to the seed domain]
3. [Question relevant to the seed domain]
4. [Question relevant to the seed domain]
5. [Question relevant to the seed domain]
6. [Question relevant to the seed domain]
7. [Question relevant to the seed domain]
8. [Question relevant to the seed domain]
9. [Question relevant to the seed domain]
10. [Question relevant to the seed domain]
...
- `entities/` -- Living docs about tools and concepts that change over time
